  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Delete Lab Admin Details</h5>
        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h4>
                Lab Admin
                <a href="add-user.php" class="btn btn-primary float-right">Add Lab Admin</a>
              </h4>
            </div>
            <div class="card-body">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                          <a href="labadmin-edit.php?LabAdminID=<?php echo $row['LabAdminID']; ?>" class="btn btn-info btn-sm">Edit</a>
                        </td>
                        <td>
                           <button type="button" value="<?php echo $row['LabAdminID']; ?>" class="btn btn-danger btn-sm deletebtn">Delete</a>
                        </td>
                      </tr>
                    <?php
                    }
