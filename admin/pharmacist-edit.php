        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="pharmacist.php" class="btn btn-danger btn-sm float-right">BACK</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  <form action="code.php" method="POST">
                    <div class="modal-body">
                      ...
                      ?>
                            ...
                            <div class="form-group">
                              <lable for="">Pharmacist ID</lable>
                              <input type="text" name="pharmacistid" value="<?php echo $row['PharmacistID'] ?>" class="form-control" placeholder="Patient ID" readonly>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="modal-footer">
                      <button type="submit" name="updatePharmacist_By_Admin" class="btn btn-info">Update</button>
                    </div>
                  </form>
                </div>
              </div>
