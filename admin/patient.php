        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h4>
                Patient
                <a href="add-user.php" class="btn btn-primary float-right">Add Patient</a>
              </h4>
            </div>
            <div class="card-body">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                          <?php echo $row['NotificationPreferences'] ?>
                        </td>
                        <td>
                          <a href="patient-edit.php?PatientID=<?php echo $row['PatientID']; ?>" class="btn btn-info btn-sm">Edit</a>
                        </td>
                        <td>
                           <button type="button" value="<?php echo $row['PatientID']; ?>" class="btn btn-danger btn-sm deletebtn">Delete</a>
                        </td>
                      </tr>
                    <?php
                    }
