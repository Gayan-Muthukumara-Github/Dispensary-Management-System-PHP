...
<!-- End Delete Patient Model-->
  ...
  <header class="site-navbar" role="banner">
      ...
      <nav class="site-navigation text-right text-md-center bg-success" role="navigation">
        <div class="">
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li><a href="dashboard.php" class="text-warning">Analytical Dashboard</a></li>
            <?php
              }
            ?>
          </ul>
        ...
        <div class="bg-light py-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Analytical Dashboard</strong></div>
                </div>
            </div>
        </div>
    ...
    ?>
            <h3 class="hny-title text-center mb-0 ">Analytical<span class="text-success"> Dashboard</span></h3>
