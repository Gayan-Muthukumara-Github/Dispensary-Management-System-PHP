  ...
  <header class="site-navbar" role="banner">
      ...
      <nav class="site-navigation text-right text-md-center bg-success" role="navigation">
        <div class="">
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <?php
              if (isset($_SESSION['auth'])) {
            ?>
            <li><a href="patientid.php" class="text-warning">Get Patient ID</a></li>
        ...
        <div class="bg-light py-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Get Patient ID</strong></div>
                </div>
            </div>
        </div>
    ...
    ?>
            <h3 class="hny-title text-center mb-0 ">Get<span class="text-success"> Patient ID</span></h3>
                ...
                <form id="contact-form">
                    <div class="p-lg-5 border">
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <input type="button" id="getPatientIDBtn" class="btn btn-info btn-lg btn-block" value="Get Patient ID">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-12 text-center">
                                <h2 id="patientID">00000</h2>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    $(document).ready(function() {
        $('#getPatientIDBtn').on('click', function() {
            $.ajax({
                url: 'code.php',
                type: 'POST',
                data: { GetPatientID: true },
                success: function(response) {
                    $('#patientID').text(response);
                },
                error: function() {
                    $('#patientID').text('Error fetching patient ID');
                }
            });
        });
    });
