...
<body>
  ...
  <header class="site-navbar" role="banner">
      ...
      <nav class="site-navigation text-right text-md-center bg-success" role="navigation">
        <div class="">
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li><a href="userprofile.php" class="text-warning">User Profile</a></li>
    ...
    ?>
            <h3 class="hny-title text-center mb-0 ">User<span class="text-success"> Profile</span></h3>
        ...
        <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <img src="images/user.png" class="center-image p-1" alt="User Image">
              </div>
            </div>
            <div class="row mb-5">
              <div class="col-md-12">
                <form id="contact-form" action="code.php" method="POST">
                  ...
                  <?php
                      if (isset($_SESSION['auth'])) {
                        ...
                        $query = "SELECT * FROM patients as P join users as U on U.UserID = P.UserID WHERE P.UserID='$UserID' LIMIT 1";
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <label for="contactdetails" class="text-black">Contact Details<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="contactdetails" name="contactdetails" value="<?php echo $row['ContactDetails'] ?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-md-6">
                        <label for="notificationpreferences" class="text-black">Notification Preferences<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="notificationpreferences" name="notificationpreferences" placeholder="" value="<?php echo $row['NotificationPreferences'] ?>">
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="password" class="form-control" id="password" name="password" placeholder="" value="<?php echo $row['Password'] ?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-12">
                        <input type="submit" name="UpdatePatient" class="btn btn-info btn-lg btn-block" value="Update">
                      </div>
                    </div>
                    <?php
                          }
